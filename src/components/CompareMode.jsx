...
function CompareMode({ currentItem, onNext, onPrev }) {
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
        <div className="bg-gray-50 rounded-xl p-6">
          <div className="flex justify-between items-center mb-3">
            <h3 className="text-sm font-medium text-gray-500">中文</h3>
          ...
          {showZhHint ? (
            <p className="text-xl text-gray-800 leading-relaxed">{highlightZhText()}</p>
          ) : (
            <p className="text-xl text-gray-800">{currentItem.zh_text}</p>
          )}
          {showZhHint && (
            <div className="flex gap-4 mt-2 text-xs">
              <span className="bg-green-200 text-green-700 px-1 rounded">绿色</span> = 已表达
              <span className="bg-orange-200 text-orange-700 px-1 rounded">橙色</span> = 遗漏
            </div>
          )}
        </div>
        <div className="bg-gray-50 rounded-xl p-6">
          ...
          {isHidden ? (
            <div className="space-y-3">
              <p className="text-xl text-gray-400 blur-sm select-none">████████ ████</p>
            ...
            <div className="space-y-3">
              <p className="text-xl text-gray-800">{currentItem.en_standard}</p>
              <button
                onClick={handleHide}
      ...
      <div className="space-y-4">
        ...
        <div className="flex gap-4">
          ...
          <button
            ...
            className="flex-1 py-2 bg-blue-500 text-white rounded-lg hover:bg-blue-600 transition-colors text-sm disabled:opacity-50 disabled:cursor-not-allowed"
          >
